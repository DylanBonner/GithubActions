[![Run App Dylan Bonner](https://github.com/DylanBonner/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/DylanBonner/GithubActions/actions/workflows/run-app.yaml)
